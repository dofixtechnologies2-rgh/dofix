...
use Modules\AdminModule\Http\Controllers\Web\Admin\PlanController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'tax-setting', 'as' => 'tax-setting.'], function () {
        Route::any('list', 'TaxSettingController@index')->name('index');
        Route::any('create', 'TaxSettingController@create')->name('create');
        Route::post('store', 'TaxSettingController@store')->name('store');
        Route::get('edit/{id}', 'TaxSettingController@edit')->name('edit'); 
        Route::put('update/{id}', 'TaxSettingController@update')->name('update'); 
        Route::delete('delete/{id}', 'TaxSettingController@destroy')->name('delete');   
    });
});
