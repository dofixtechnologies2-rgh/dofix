...
@section('title',"Category Extra Update")
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">Category Extra Update</h2>
                    </div>

                    <div class="card category-setup mb-30">
                        <div class="card-body p-30">
                            <form action="{{route('admin.extra.update')}}" method="post"
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            @else
                                                ...
                                                <div class="form-floating form-floating__icon mb-30">
                                                    <input type="text" name="price" class="form-control"
                                                           placeholder="Price" value="{{$extra['price']}}" r required>
                                                    <label>Price</label>
                                                </div>
                                            ...
                                            <div class="form-floating form-floating__icon mb-30">
                                                <select class="select-zone theme-input-style w-100" name="category_id"
                                                    ...
                                                    @foreach($categories as $categoryData)
                                                        <option value="{{$categoryData['id']}}" {{$categoryData->id==$extra->category_id ?'selected':''}}>{{$categoryData->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-floating form-floating__icon mb-30">
                                                <select class="select-zone theme-input-style w-100" name="status"
                                                    ...
                                                    <option value="1" @if($extra['status']==1) selected @endif>Active</option>
                                                    <option value="0" @if($extra['status']==0) selected @endif>InActive</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img src="{{$extra->image}}" alt="{{translate('category image')}}">
                                                    </div>
