                                        ...
                                        <table id="example" class="table align-middle">
                                            ...
                                            @foreach($categories as $key=>$category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switcher">
                                                            <input class="switcher_input top_rated-update"
                                                                    type="checkbox"
                                                                    {{$category->top_rated?'checked':''}} data-top_rated="{{$category->id}}">
                                                            <span class="switcher_control"></span>
                                                        </label>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <label class="switcher">
                                                            <input class="switcher_input quick_repair-update"
                                                                    type="checkbox"
                                                                    {{$category->quick_repair?'checked':''}} data-quick_repair="{{$category->id}}">
                                                            <span class="switcher_control"></span>
                                                        </label>
                                                    </td>
...
@push('script')
    ...
    <script>
        ...
        $('.top_rated-update').on('click', function () {
            let itemId = $(this).data('top_rated');
            let route = '{{route('admin.category.top_rated-update',['id' => ':itemId'])}}';
            route = route.replace(':itemId', itemId);
            route_alert(route, '{{ translate('want_to_update_status') }}');
        
        })

        $('.quick_repair-update').on('click', function () {
            let itemId = $(this).data('quick_repair');
            let route = '{{route('admin.category.quick_repair-update',['id' => ':itemId'])}}';
            route = route.replace(':itemId', itemId);
            route_alert(route, '{{ translate('want_to_update_status') }}');
