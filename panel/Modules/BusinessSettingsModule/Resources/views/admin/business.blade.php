                                            ...
                                            <div class="discount-type">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-30">
                                                            <div class="form-floating">
                                                                ...
                                                                <div class="">
                                                                    <input type="text" class="country-picker-phone-number w-50" value="+91" name="business_phone" hidden  readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="mb-30">
                                                ...
                                                <div class="row align-items-end">
                                                    ...
                                                    <div class="col-md-6 col-12 mb-30">
                                                        <div class="form-floating form-floating__icon">
                                                            <input type="number" class="form-control"
                                                                   name="minimum_wallet_amount_for_listing"
                                                                   placeholder="{{translate('ex: 2000')}} *"
                                                                   min="1"
                                                                   step="any"
                                                                   required
                                                                   value="{{$dataValues->where('key_name','minimum_wallet_amount_for_listing')->first()->live_values??''}}">
                                                            <label>{{translate('Wallet Minimum Balance to Appear in List')}} *</label>
                                                            <span class="material-icons">local_atm</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <form action="javascript:void(0)" method="POST" id="booking-system-update-form">
                                            ...
                                            <div class="row g-4">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="cancelation_fee"
                                                               placeholder="Cancelation Fee *"
                                                               type="number" value="{{$dataValues->where('key_name', 'cancelation_fee')->first()->live_values ?? ''}}" required
                                                               value="">
                                                               <i class="material-symbols-outlined cursor-pointer"
                                                                    data-bs-toggle="tooltip"
                                                                    data-bs-placement="top"
                                                                    title="{{translate('Please enter percentage value for cancelation charge. For example, enter 20 for 20% of the total amount to be charged as cancelation fee.')}}"
                                                                    >info</i>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="partial_payment"
                                                               placeholder="Partial Payment *"
                                                               type="number" value="{{$dataValues->where('key_name', 'partial_payment')->first()->live_values ?? ''}}" required
                                                               value="">
                                                                <i class="material-symbols-outlined cursor-pointer"
                                                                    data-bs-toggle="tooltip"
                                                                    data-bs-placement="top"
                                                                    title="{{translate('Please enter percentage value for partial payment. For example, enter 30 for 30% of the total amount to be paid as partial payment.')}}"
                                                                    >info</i>
