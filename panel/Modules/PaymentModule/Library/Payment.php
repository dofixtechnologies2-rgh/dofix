...
class Payment
{
    ...
    public function __construct($success_hook, $failure_hook, $currency_code, $payment_method, $payment_platform, $payer_id = null, $receiver_id = null, $additional_data = [], $payment_amount = 0, $partial_amount = 0, $external_redirect_link = null, $attribute = null, $attribute_id = null)
    {
