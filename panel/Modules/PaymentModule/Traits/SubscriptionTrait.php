...
trait SubscriptionTrait
{
    ...
    public static function handleWalletRecharge($provider, $request, $price, $name): bool
    { 

        try { 
           
            shiftWalletRechargeTransaction(
                amount: $price,
                provider_id: $provider
            ); 
    ...
    public static function handleWalletRechargeFailed($provider, $request, $price, $name): bool
    {
        DB::beginTransaction();
