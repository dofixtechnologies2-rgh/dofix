                                        ...
                                        <div class="col-md-6">
                                            <div class="upload-file w-100">
                                                <label class="imgUplaodFile">
                                                  <input type="file" class="file_uploader" id="adhar_img" name="adhar_image" required="" accept="image/*"capture="environment"
                                                    onchange="previewImage(event, 'adhar_preview')"
                                                  />
                                                  <img id="adhar_preview" src="https://lab7.invoidea.in/dofixweb/public/web/images/Upload-Image.svg"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="upload-file w-100">
                                                <label class="imgUplaodFile">
                                                  <input type="file" class="file_uploader" id="pan_img" name="pan_img" required="" accept="image/*"capture="environment"
                                                    onchange="previewImage(event, 'pan_preview')"
                                                  />
                                                  <img id="pan_preview" src="https://lab7.invoidea.in/dofixweb/public/web/images/Upload-Image.svg"
                                                    class="img-fluid preview-img"
                                                    alt="Upload Image"
                                                    style="width: 20px"/>
                                                  Upload Image*
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="upload-file w-100">
                                                <label class="imgUplaodFile">
                                                  <input type="file" class="file_uploader" id="dl_img" name="dl_img" required="" accept="image/*"capture="environment"
                                                    onchange="previewImage(event, 'dl_preview')"
                                                  />
                                                  <img id="dl_preview" src="https://lab7.invoidea.in/dofixweb/public/web/images/Upload-Image.svg"
                                                    class="img-fluid preview-img"
                                                    alt="Upload Image"
                                                    style="width: 20px"/>
                                                  Upload Image*
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="upload-file w-100">
                                            <label class="imgUplaodFile">
                                              <input type="file" class="file_uploader" id="profile_img" name="profile_img" required="" accept="image/*"capture="environment"
                                                onchange="previewImage(event, 'profile_preview')"
                                              />
                                              <img id="profile_preview" src="https://lab7.invoidea.in/dofixweb/public/web/images/Upload-Image.svg"
                                                class="img-fluid preview-img"
                                                alt="Upload Image"
                                                style="width: 20px"/>
                                              Upload Image*
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="upload-file w-100">
                                                <label class="imgUplaodFile">
                                                  <input type="file" class="file_uploader" id="ban_docs" name="ban_docs" required="" accept="image/*"capture="environment"
                                                    onchange="previewImage(event, 'bank_doc_preview')"
                                                  />
                                                  <img id="bank_doc_preview" src="https://lab7.invoidea.in/dofixweb/public/web/images/Upload-Image.svg"
                                                    class="img-fluid preview-img"
                                                    alt="Upload Image"
                                                    style="width: 20px"/>
                                                  Upload Image*
