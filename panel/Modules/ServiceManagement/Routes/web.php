...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'service', 'as' => 'service.'], function () {
        ...
        Route::post('update-modal-variant', 'ServiceController@updateVariant')->name('update-modal-variant');
        ...
        Route::any('ajax-db-variant/{variant_key}/{service_id}', 'ServiceController@ajaxDbVariant')->name('ajax-db-variant')->withoutMiddleware('csrf');
    });
