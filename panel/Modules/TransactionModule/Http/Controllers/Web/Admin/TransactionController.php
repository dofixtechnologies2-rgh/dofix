...
class TransactionController extends Controller
{
    ...
    public function download(Request $request)
    {
        ...
        $items = $this->transaction::with(['from_user:id,first_name,last_name',
        ...
        foreach ($items as &$item) {
            $item->from_user_name = $item->from_user->first_name ?? null;
            $item->to_user_name = $item->to_user->first_name ?? null;
            unset($item->id);
            unset($item->from_user_id);
            unset($item->to_user_id);
            unset($item->updated_at);
            unset($item->booking_repeat_id);
            unset($item->from_user);
            unset($item->to_user);
        }
