                        ...
                        <div class="card-body p-30">
                            <form action="{{route('admin.banner.update',[$banner->id])}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-30" id="position">
                                            <select class="js-select theme-input-style w-100" name="position">
                                                <option value="1" {{$banner->position==1 ? 'selected' : ''}}>Main Banner</option>
                                                <option value="0" {{$banner->position==0 ? 'selected' : ''}}>Bottom Banner</option>
                                            </select>
                                        </div>
                                    </div>
