                   ...
                   id="providerForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="profile_img" class="form-label">Company Name*</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="profile_img" class="form-label">Full Name*</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="profile_img" class="form-label">Contact Number*</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="profile_img" class="form-label">Alternate Contact Number</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="profile_img" class="form-label">Email*</label>
                        ...
                        {{-- <div class="col-md-6 mb-3">
                            <label for="adhar_number" class="form-label">Location*</label>
                            <label class="pickLocation-wrap">
                            <input type="text" id="address" placeholder="Address*" required name="address">
                            <button id="pickLocation" type="button">📍 Pick location from map</button>
                            </label>
                            @error('address')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            <div id="uploadprofile">
                                <label for="adhar_img" class="form-label">Adhar card image*</label>
                                <label class="imgUplaodFile"> 
                                    <input type="file" id="adhar_img" name="adhar_image" required accept="image/*" capture="environment" onchange="previewImage(event, 'adhar_preview')">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div id="uploadprofile">
                                ...
                                <label class="imgUplaodFile"> 
                                    <input type="file" id="pan_img" name="pan_img" required accept="image/*" capture="environment" onchange="previewImage(event, 'pan_img_preview')">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div id="uploadprofile">
                                <label for="dl_img" class="form-label"> Driving licence image*</label>
                                <label class="imgUplaodFile"> 
                                    <input type="file" id="dl_img" name="dl_image" required accept="image/*" capture="environment" onchange="previewImage(event, 'dl_image_preview')">
